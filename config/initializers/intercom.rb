IntercomRails.config do |config|
  ...
  if Rails.env.development?
    config.app_id = ENV["INTERCOM_APP_ID"] || "y0k7kpq2"
  else
    config.app_id = ENV["INTERCOM_APP_ID"] || "lysgn6zx"
  end    
  ...
  #
  config.api_secret = "CUtYOHvz65CCiJGhmIyAwsrdI8kye0sQWjYVxDo_"
  ...
  config.user.custom_data = {
     :number_of_neutral_months => :number_of_neutral_months
   }
