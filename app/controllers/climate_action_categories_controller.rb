class ClimateActionCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @climate_action_category.save
        format.html { redirect_to @climate_action_category, notice: "Climate action category was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to climate_action_categories_url, notice: "Climate action category was successfully destroyed." }
