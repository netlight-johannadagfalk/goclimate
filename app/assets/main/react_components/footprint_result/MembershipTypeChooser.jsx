...
const MembershipTypeChooser = () => {
    ...
    return (
        <form className="space-y-3" data-target="registrations--price.peopleForm" data-url="/users/sign_up" action="/users/sign_up" accept-charset="UTF-8" method="get">
            ...
            <SelectButton buttonType="free" preChecked={false} boldDisplayedText="Free account." unBoldDisplayedText="Track your carbon footprint over time." />
            <SelectButton buttonType="single" preChecked={true} boldDisplayedText="Offset" unBoldDisplayedText=" your carbon footprint through climate projects."/>
            <SelectButton buttonType="multi" preChecked={false} boldDisplayedText="Offset multiple times." unBoldDisplayedText="Offset more for yourself or for loved ones."/>
        </form>
    )
}
