...
const Payment = ({ selectedMembership }) => {
    return (
      <div className="text-left">
        <label className="block font-semibold mt-3">{useTexts().commonText.email}</label>
        <input className="input w-full"/>
        <label className="block font-semibold mt-3">{useTexts().commonText.password}</label>
        <input className="input w-full"/>
        { selectedMembership !== "free" &&
          <>
            <label className="block font-semibold mt-3">{useTexts().commonText.credit_or_debit_card}</label>
