...
const FAQ = () => {
    ...
    const { registrationsText: { faq }, commonText: { faq_questions }} = useTexts()
    ...
    Object.keys(questionKeys).forEach((questionCategory) => {
        const filteredQuestionsForCategory = Object.entries(faq_questions[questionCategory].questions).filter(([q])=> questionKeys[questionCategory].includes(q))
