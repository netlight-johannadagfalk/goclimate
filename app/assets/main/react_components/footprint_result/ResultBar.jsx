 ...
 */
const ResultBar = ({ title, width, value, color = "bg-primary", fontWeight = "", spaceStyling = "", spanWidth = "" }) => {
    return (
        <div className={spaceStyling}>
            ...
            <div className="flex-1 pr-24">
                <div className={"relative h-5 m-lg:h-6 " + (width > 0 ? "box-content pr-2" : "")} style={{width: width + "%"}}>
                    ...
                    <span className={"text-left absolute left-100 top-1/2 transform -translate-y-1/2 leading-none font-bold " + spanWidth}>
                        {value}
                    </span>
                </div>
            </div>
