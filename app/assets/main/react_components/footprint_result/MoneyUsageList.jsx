...
const MoneyUsageList = () => {
    ...
    const { registrationsText: { where_does_the_money_go, where_does_the_money_go: { heading } } } = useTexts()
    const listValues = Object.entries(where_does_the_money_go).filter(([key]) => key !== "heading")
