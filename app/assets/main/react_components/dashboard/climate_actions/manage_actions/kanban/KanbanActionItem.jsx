  ...
  return (
    ...
    >
      {(provided, snapshot) => {
        return (
          <div
            className={`rounded-lg w-80 space-y-3 mb-2 focus:outline-none transistion duration-500 transform hover:-translate-y-1 hover:scale-102 ${
              collapsed ? "d:w-24" : "d:w-auto border border-gray-tint-2 mx-5"
            } 
