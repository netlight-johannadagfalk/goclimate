...
export const useTexts = () => {
    ...
    if(!context)
        throw new Error('TextsContext does not exist.')
    return context
}
...
export const TextsProvider = ({ children, commonText, lifestyleFootprintsText, modelText, registrationsText, slug, reactContentText }) => {
    ...
    texts.registrationsText.accept_policies = texts.registrationsText.accept_policies.replace("<a>","<a href='" + (slug ? "/" + slug : "") + "/privacy-policy' target='_blank'>" )
