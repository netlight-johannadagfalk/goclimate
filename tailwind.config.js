...
module.exports = {
  ...
  theme: {
    ...
    screens: {
      // Default: Mobile
      'm-xxs': '350px', // Special case for React: Extra extra small screen
      'm-xs': '420px', // Special case for React: Extra small screen
      'm-s': '550px', // Special case for React: Small screen
    ...
    boxShadow: {
      DEFAULT:
        '0 3px 10px -3px rgba(28, 70, 55, 0.2), 0 1px 3px 0px rgba(28, 70, 55, 0.1)',
    ...
    extend: {
      ...
      transitionProperty: {
        DEFAULT:
          'background-color, border-color, color, fill, stroke, opacity, box-shadow, transform, border-width, height, width, max-height, max-width',
        border: 'border-width',
